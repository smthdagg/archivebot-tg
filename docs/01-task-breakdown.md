...
**最后更新：2026-09-01（M9 部署手册 7c00f2b · 重试 819796a）**
...
| M7 安全加固 | 🔶 大部分完成 | SSRF 三层防线/50MB 预检/RBAC/所有权校验 ✅；**失败自动重试已实现（819796a）、Web Admin 限流+登录锁定已完成（t_fd0a2028：滑动窗口 100 次/分/IP + 登录失败锁定+指数退避）** | 9de57a4 → ea4dc1a |
